...
{
    public class K_Graph_SolverInit
    {
        public K_Graph_SolverInit(int colorLimit, IDictionary<int, Node> nodeData, bool hasConnectionMatrix, bool randomizeConnections = false)
        {
            this.ColorLimit = colorLimit;
            this.NodeData = nodeData;
            this.HasConnectionMatrix = hasConnectionMatrix;

            if (!hasConnectionMatrix || randomizeConnections)
